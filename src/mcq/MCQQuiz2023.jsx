...
import data from '../gs-1-prelims/gs-1-prelims-23/data.json';
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <Container maxWidth="lg" sx={{ py: 4, flexGrow: 1 }}>
        <Typography variant="h4" gutterBottom sx={{ color: 'primary.main' }}>Civil Services (Preliminary) Examination, 2023</Typography>
